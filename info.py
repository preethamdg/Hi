...
# Bot Admins
ADMINS = environ.get('ADMINS', '7405406082 5911514776')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002167205597').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002334874259')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002490084393')
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/Sanjudg01")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/any_support_01')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+y-d-YdGnh7MzNTU1')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+y-d-YdGnh7MzNTU1")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/+y-d-YdGnh7MzNTU1")
